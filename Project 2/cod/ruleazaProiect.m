...
%citeste o imagine
img = imread('KeanuReeves.jpg');

%reducem imaginea in latime cu 20 de pixeli
%seteaza parametri
parametri.optiuneRedimensionare = 'miscoreazaInaltime';
...
imwrite(img,strcat('KeanuReeves','initial.jpg'));
imwrite(imgRedimensionata_proiect,strcat('KeanuReeves',parametri.metodaSelectareDrum,'redimensionat.jpg'));
imwrite(imgRedimensionata_traditional,strcat('KeanuReeves','imresize.jpg'));
